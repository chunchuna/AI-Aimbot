...
antiflashConf = 0.5
# Block user mouse/keyboard input during anti-flash turn (requires admin)
antiflashBlockInput = True
# Anti-flash FOV: only trigger for flashes within this pixel radius of screen center (0 = no limit)
antiflashFOV = 0
